  ...
  <main id="main">
    <div class="row m-0"> 
      ...
      <div class="main-content p-3">
  		  <div class="card">
			<form class="m-3" method="post" action="<?php echo e(url('addpurchase')); ?>" enctype="multipart/form-data">
			  <div class="row">
  			  	<div class="col-lg-12">
...
<?php echo $__env->make('main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\toko\resources\views/addpurchase.blade.php ENDPATH**/ ?>