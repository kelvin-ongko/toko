...
<body>
    <div class="container">
                ...
                <div class="flex-container">
                    <div class="flex-container-logo">
                        <div class="container-logo">
                            <img class="logo" src="<?php echo e(asset('assets/logo.png')); ?>" alt="">
                        </div>
                        <div class="toko">
        ...
        <div class="flex-container-1">
            ...
            <div class="info">
                <ul>
                    <li>: <?php echo e($transaction->transaction_id); ?> </li>
                    <li>: <?php echo e($transaction->customer); ?> </li>
                </ul>
            </div>
            <div class="left">
                <ul>
            ...
            <div class="info">
                <ul>
                    <li>: <?php echo e($transaction->date); ?> </li>
                    <li>: <?php echo e($transaction->admin_id); ?> </li>
                </ul>
            </div>
        </div>
        <hr>
        ...
        <?php $__currentLoopData = $transactiondetail; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="flex-container" style="text-align: right;">
                <div class="flex-container-2">
                    <div class="number" style="text-align:left;"><?php echo e($i++); ?>.</div>
                    <div class="product" style="text-align:left;"><?php echo e($item->brand); ?> <?php echo e($item->name); ?></div>
                    <div class="price">Rp <?php echo e(number_format($item->price)); ?> </div>
                    <div class="qty"><?php echo e($item->qty); ?> </div>
                    <div class="qty"><?php echo e($item->discount); ?> %</div>
                    <div class="pricetotal" style="text-align:right;">Rp <?php echo e(number_format($item->total)); ?> </div>
                </div>
            </div>
        ...
        <div class="flex-container" style="text-align: right;">
            <div class="flex-container-2">
                ...
                <div style="text-align: right; width: 150px">
                    <ul>
                        <li>Rp <?php echo e(number_format($transaction->total)); ?> </li>
                        <li><?php echo e($transaction->discount); ?> %</li>
                        <li>Rp <?php echo e(number_format($transaction->grandtotal)); ?> </li>
                    </ul>
                </div>
            </div>
        </div>
...
</html><?php /**PATH C:\xampp\htdocs\toko\resources\views/invoice.blade.php ENDPATH**/ ?>